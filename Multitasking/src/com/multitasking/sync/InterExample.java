...
public class InterExample {
	...
	// 1. wait, notify and notifyAll() →  used in object and not in thread
	//2. These methods only call inside sync area only because every thread is owner of any object. and each thread has lock.
